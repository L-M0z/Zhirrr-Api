...
var creatorList = ['@L-M0','@Lynx','@ling_.mo','@Lmoz', '@LMzero','@LING-ganz','@LYNX-MO'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6288708344182 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    notcharagi: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'masukan parameter charagi'
    },
    nottext3: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'NEGEV') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'NEGEV') return res.json(loghandler.invalidKey)
